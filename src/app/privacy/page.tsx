    ...
    <div className="min-h-screen bg-[#12131a] py-20 px-6">
      <div className="max-w-3xl mx-auto space-y-8 text-[#e2e1eb]">
        ...
        <div className="space-y-6 text-[#c7c4d7] leading-relaxed">
          <section>
            <h2 className="text-2xl font-semibold text-[#e2e1eb] mb-3">1. Introduction</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#e2e1eb] mb-3">2. The Data We Collect About You</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#e2e1eb] mb-3">3. How We Use Your Personal Data</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-[#e2e1eb] mb-3">4. Data Security</h2>
            <p>We have put in place appropriate security measures to prevent your personal data from being accidentally lost, used or accessed in an unauthorized way, altered or disclosed. In addition, we limit access to your personal data to those employees, agents, contractors and other third parties who have a business need to know.</p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-[#e2e1eb] mb-3">5. Contact Us</h2>
