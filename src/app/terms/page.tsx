    ...
    <div className="min-h-screen bg-background py-20 px-6">
      <div className="max-w-3xl mx-auto space-y-8 text-foreground">
        ...
        <div className="space-y-6 text-muted leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-3">3. AI Generation & Content</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-3">4. Disclaimer</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-foreground mb-3">5. Limitations</h2>
